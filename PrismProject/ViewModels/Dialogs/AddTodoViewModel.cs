...
{
    public class AddTodoViewModel : NavigationViewModel
    {
        public AddTodoViewModel(ITodoService service, IContainerProvider containerProvider) : base(containerProvider)
        {
            CurrentDto = new TodoDto();  // 实例化临时数据存储对象
        ...
        private async void ConfirmAsync()
        {
            ...
            BaseResponse<TodoDto> addResult;
